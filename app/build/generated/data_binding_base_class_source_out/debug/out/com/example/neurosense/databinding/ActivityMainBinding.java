...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.guestPlay;
      Button guestPlay = ViewBindings.findChildViewById(rootView, id);
      if (guestPlay == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, buttonLogin, buttonSignup,
          guestPlay, titleMain);
    }
